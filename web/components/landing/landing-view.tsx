          ...
          <div className="flex items-center gap-2">
            <Link
              ...
              className={cn(
                ...
                "hidden border-white/15 bg-white/5 text-white hover:bg-white/10 sm:inline-flex",
              )}
            >
              Live demo
            </Link>
            <Link
              ...
              className={cn(
                ...
                "landing-cta-shimmer border-0 bg-gradient-to-r from-cyan-500 via-blue-600 to-violet-600 text-white shadow-[0_0_28px_rgba(59,130,246,0.35)] hover:from-cyan-400 hover:via-blue-500 hover:to-violet-500",
              )}
            >
              Book demo
            </Link>
      ...
      <footer className="relative z-10 border-t border-white/10 bg-[#05060a]/65 py-7 backdrop-blur-md sm:py-8">
        <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
          ...
          <div className="flex flex-wrap gap-4 text-xs text-zinc-500">
            ...
            <Link className="text-cyan-400/90 hover:text-cyan-300" href="/">
              Live demo →
            </Link>
          </div>
        </div>
